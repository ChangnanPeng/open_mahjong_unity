...
public partial class NormalGameStateManager {
    ...
    public bool IsJianzhong() {
        if (roomRule == "jianzhong") return true;
        return !string.IsNullOrEmpty(subRule) && subRule.StartsWith("jianzhong");
    }
    ...
    public void TryResumeAfterSichuanContinue() {
        ...
        // Jianzhong mid-hand hu uses RoundEndPresentation only as the coroutine host
