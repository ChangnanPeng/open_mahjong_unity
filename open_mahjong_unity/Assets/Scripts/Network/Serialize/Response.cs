...
public class DoActionInfo { // 执行操作
    ...
    public int action_tick;
    public int? cut_from_player;
    public float? meld_reveal_delay;
...
public class PlayerInfo { // 房间信息中单个玩家信息
    ...
    public string[] initial_hu_types;
}
...
public class RuleStatsResponse { // 单个规则的统计数据响应
    ...
    public Dictionary<string, int> ranked_fan_stats;
}
