...
public static class FanTextDictionary {
    ...
    /// <summary>
    /// 简中番表，key 使用服务端 stable fan id。
    /// </summary>
    public static readonly Dictionary<string, string> FanToDisplayJianzhong = new Dictionary<string, string> {
    ...
    public static readonly Dictionary<string, string> FanNameToDisplayJianzhong = new Dictionary<string, string> {
        ...
        {"haitei", "海底捞月"}, {"houtei", "河底捞鱼"},
        {"rinshan", "杠上开花"}, {"chankan", "抢杠"},
    ...
    public static string GetFanNameDisplayText(string rule, string fanName) {
        ...
        if (rule == "jianzhong/standard") {
            if (FanNameToDisplayJianzhong.TryGetValue(fanName, out string displayName)) {
                return displayName;
            }
        }
    ...
    public static string GetFanDisplayText(string rule, string fanName) {
        ...
        else if (rule == "jianzhong/standard") map = FanToDisplayJianzhong;
