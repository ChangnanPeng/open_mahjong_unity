...
public static class FanTextDictionary {
    ...
    /// <summary>
    /// 新规则番表，key 使用服务端 stable fan id。
    /// </summary>
    public static readonly Dictionary<string, string> FanToDisplayNewRule = new Dictionary<string, string> {
    ...
    public static readonly Dictionary<string, string> FanNameToDisplayNewRule = new Dictionary<string, string> {
    ...
    public static string GetFanNameDisplayText(string rule, string fanName) {
        ...
        if (rule == "new_rule/standard") {
            if (FanNameToDisplayNewRule.TryGetValue(fanName, out string displayName)) {
                return displayName;
            }
        }
        return fanName;
