...
class RoomManager:
    def __init__(self, game_server):
        ...
        self.room_validators = {
            ...
            "jianzhong": JianzhongRoomValidator
        }
        # 不同规则挂载的游戏验证器
    ...
    async def create_Jianzhong_room(self, player_id: str, room_name: str, gameround: int,
                                  password: str, roundTimerValue: int, stepTimerValue: int,
                                  tips: bool, random_seed: int = 0, sub_rule: str = "jianzhong/standard",
                                  tourist_limit: bool = False, allow_spectator: bool = True,
                                  tactical_call: bool = False, claim_protection: bool = True,
        ...
        try:
            ...
            try:
                validator_class = self.room_validators["jianzhong"]
                validated_config = validator_class(**room_config)
            except ValueError as e:
