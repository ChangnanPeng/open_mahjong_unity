...
class NewRuleSettlementPolicy:
    """New-rule scoring adapter, separate from hand flow and action handling."""
    ...
    def build(
        ...
        *,
        ...
        calculation_service = game_state.calculation_service
        if calculation_service is not None and hasattr(calculation_service, "NewRule_hepai_detail"):
            detail = calculation_service.NewRule_hepai_detail(
                hand_tiles,
