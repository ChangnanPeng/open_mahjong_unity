...
def test_manager_starts_and_cleans_up_new_rule_game_state() -> None:
...
def run() -> None:
    tests = [
        test_manager_starts_and_cleans_up_new_rule_game_state,
    ]
    for test in tests:
        test()
    print(f"new_rule gamestate_manager tests ok: {len(tests)} tests")
