...
JIANDAN_MID_HU_ANIM_SECONDS = 0.5
...
class JiandanGameState:
    """Live Jiandan game state assembled from independent rule policies."""
    ...
    def emit_mid_hand_hu_payloads(
        ...
        *,
        ...
        self.outbound_payloads.append({
            "type": "gamestate/jiandan/_internal_mid_hand_hu_delay",
            "delay_seconds": JIANDAN_MID_HU_ANIM_SECONDS,
        })
        return payloads
