...
from server.gamestate.game_jiandan.get_action import get_action, get_ai_action


def _with_fake_server(game: JiandanGameState) -> None:
...
def run() -> None:
    ...
    for test in tests:
        test()
    print(f"jiandan get_action tests ok: {len(tests)} tests")
