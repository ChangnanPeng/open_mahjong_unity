...
def test_manager_starts_and_cleans_up_jiandan_game_state() -> None:
...
def run() -> None:
    tests = [
        test_manager_starts_and_cleans_up_jiandan_game_state,
    ]
    for test in tests:
        test()
    print(f"jiandan gamestate_manager tests ok: {len(tests)} tests")
