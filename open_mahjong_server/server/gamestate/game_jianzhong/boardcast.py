...
def game_start_payload(game_state: Any, viewer_index: int, *, reveal_final: bool = False) -> dict:
    ...
    return {
        "type": "gamestate/jianzhong/game_start",
        "success": True,
...
def ask_action_payload(
    ...
    *,
    ...
    return {
        "type": "gamestate/jianzhong/broadcast_hand_action" if is_hand_action else "gamestate/jianzhong/ask_other_action",
        "success": True,
...
def visible_action_payload(
    ...
    *,
    ...
    payload = {
        "type": "gamestate/jianzhong/do_action",
        "success": True,
        "action": action,
        "player": actor,
        "tile": public_tile,
...
def mid_hand_hu_result_payload(
    ...
    *,
    ...
    if source == "self_draw" and viewer_index != winner_index:
        hepai_tile = 0
    return {
        "type": "gamestate/jianzhong/show_result",
        "success": True,
        "message": "显示中途和牌",
        "game_info": game_info_payload(game_state, viewer_index),
        "show_result_info": {
...
def ready_status_payload(game_state: Any, viewer_index: Optional[int]) -> dict:
    ...
    return {
        "type": "gamestate/jianzhong/ready_status",
        "success": True,
        "player_index": viewer_index,
...
def game_end_payload(game_state: Any, viewer_index: Optional[int]) -> dict:
    ...
    return {
        "type": "gamestate/jianzhong/game_end",
        "success": True,
        "player_index": viewer_index,
        "message": "game end",
        "game_end_info": {
