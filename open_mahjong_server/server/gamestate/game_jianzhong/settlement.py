...
class JianzhongSettlementPolicy:
    """Jianzhong scoring adapter, separate from hand flow and action handling."""
    ...
    def build(
        ...
        *,
        ...
        detail = game_state.calculation_service.Jianzhong_hepai_detail(
            hand_tiles,
        ...
        if not detail["is_win"]:
            raise ValueError(f"Confirmed win for player {winner_index} is not a valid Jianzhong hand.")
        return {
