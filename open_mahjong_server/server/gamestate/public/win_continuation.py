...
class WinContinuationPolicy:
    ...
    def from_room_data(
        ...
        *,
        ...
        # Compatibility for rooms created before the three-way option existed.
        legacy_blood_battle = room_data.get("blood_battle")
        if legacy_blood_battle is not None:
            return cls(HandEndMode.THIRD_WIN if bool(legacy_blood_battle) else HandEndMode.FIRST_WIN)
        return cls(default)
