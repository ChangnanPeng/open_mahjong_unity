...
class GameServer:
    ...
    async def create_NewRule_room(self, Connect_id: str, room_name: str, gameround: int, password: str, roundTimerValue: int, stepTimerValue: int, tips: bool, random_seed: int = 0, sub_rule: str = "new_rule/standard", tourist_limit: bool = False, allow_spectator: bool = False, tactical_call: bool = False, claim_protection: bool = True) -> Response:
        return await self.room_manager.create_NewRule_room(Connect_id, room_name, gameround, password, roundTimerValue, stepTimerValue, tips, random_seed, sub_rule, tourist_limit, allow_spectator, tactical_call, claim_protection)
