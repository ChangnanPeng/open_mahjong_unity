...
from server.game_calculation.jianzhong import tingpai_check
from server.game_calculation.jianzhong.tiles import ORPHANS
...
def run() -> None:
    ...
    for test in tests:
        test()
    print(f"jianzhong tingpai smoke tests ok: {len(tests)} tests")
