...
from server.game_calculation.jiandan import tingpai_check
from server.game_calculation.jiandan.tiles import ORPHANS
...
def run() -> None:
    ...
    for test in tests:
        test()
    print(f"jiandan tingpai smoke tests ok: {len(tests)} tests")
