...
class GameCalculationService:
    ...
    def Jiandan_tingpai_check(
        ...
        """Check waiting tiles with the Jiandan scoring engine."""
        with self._lock:
    ...
    def Jiandan_hepai_check(
        ...
        """Jiandan scoring entry point.

        This thin adapter keeps the existing calculation-service calling style
        while the jiandan calculator remains independently testable.
    ...
    def Jiandan_hepai_detail(
        ...
        """Return full Jiandan scoring details for tests and game flow."""
        context = context or {}
